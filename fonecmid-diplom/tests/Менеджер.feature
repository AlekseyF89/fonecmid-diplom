		...
		* Я создаю новый документ "Обслуживание клиента"
			...
			* Я создаю нового контрагента
				...
				* Я создаю новый абонентский договор
					...
					И из выпадающего списка с именем "Организация" я выбираю точное значение 'ООО "Комьютеры"'
					...
					И в поле с именем 'ВКМ_ДатаНачала' я ввожу текст '01.09.2025'
					И я нажимаю кнопку выбора у поля с именем "ВКМ_ДатаОкончания"
					И в поле с именем 'ВКМ_ДатаОкончания' я ввожу текст '31.09.2025'
			...
			И в таблице "Список" я выбираю текущую строку
			Тогда открылось окно 'Обслуживание клиента (создание) *'
			И из выпадающего списка с именем "ВКМ_Специалист" я выбираю точное значение 'СпецомАВ'
			И я нажимаю кнопку выбора у поля с именем "ВКМ_ДатаПроведенияРабот"
			И в поле с именем 'ВКМ_ДатаПроведенияРабот' я ввожу текст '28.09.2025'
		...
		Тогда таблица "Список" содержит строки:
				...
				| '$НомерДокумента1$' | 'Аб-Тл-1' | '$ДатаДокумента1$' | 'Театрол'                    | 'СпецомАВ'    |
...
*Я создаю второй документ "Обслуживание клиента"
	* Я открываю форму списка документа "Обслуживание клиентов"
		...
		* Я создаю новый документ "Обслуживание клиента"
			...
			И из выпадающего списка с именем "ВКМ_Специалист" я выбираю точное значение 'СпецомАВ'
			И я нажимаю кнопку выбора у поля с именем "ВКМ_ДатаПроведенияРабот"
			И в поле с именем 'ВКМ_ДатаПроведенияРабот' я ввожу текст '31.09.2025'
			И в поле с именем 'ВКМ_ВремяНачалаРабот' я ввожу текст '12:00:00'
		...
		Тогда таблица "Список" содержит строки:
			| 'Номер'     | 'Договор' | 'Дата'                | 'Клиент'                     | 'Специалист'   |
			| '$НомерДокумента2$' | 'Аб-Тл-1' | '$ДатаДокумента2$' | 'Театрол'                      | 'СпецомАВ'    |
