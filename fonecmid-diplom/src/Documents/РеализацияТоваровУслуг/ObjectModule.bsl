...
//ВКМ+ ФроловАВ 28.09.2025 добавление автозаполнение таблицы услуги
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт
	...
	Пока Результат.Следующий() Цикл
		Если Результат.Сумма > 0 Тогда
			...
			НоваяСтрока.Цена = Результат.Договор.ВКМ_СтавкаЧаса;
			НоваяСтрока.Количество = Результат.Сумма / Результат.Договор.ВКМ_СтавкаЧаса;
